...
@Name("calendarModelQuarter")
@ApplicationScoped
public class CalendarModelQuarter extends CalendarModelBase
{
private static final int OFFSET_ENABLED_DAY = 0;
	...
	public CalendarDataModelItem[] getData(Date[] dateArray)
	{
		...
		for (int i = 0; i < dateArray.length; i++)
		{
			...
			{
				if (!checkLastDayOfMonth(current) || current.get(Calendar.MONTH)%3 != 2)
				{
