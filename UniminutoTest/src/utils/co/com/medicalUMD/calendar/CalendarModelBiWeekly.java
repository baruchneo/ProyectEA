...
@Name("calendarModelBiweekly")
@ApplicationScoped
public class CalendarModelBiWeekly extends CalendarModelBase
{
	...
	public CalendarDataModelItem[] getData(Date[] dateArray)
	{
		...
		for (int i = 0; i < dateArray.length; i++)
		{
			...
			{
				if (!checkLastDayOfMonth(current) && current.get(Calendar.DAY_OF_MONTH) != 15)
				{
